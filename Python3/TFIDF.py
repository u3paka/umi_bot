...
database = SqliteExtDatabase('/Users/xxxx')
database.connect()
...
class managementInfos(BaseModel):
...
def incDocFreq(word):
	try:
		database.create_tables([managementInfos, tfidf], True)
...
if __name__ == '__main__':
	...
	intext2 = 'dd\nd'
	key = calcKWs(intext2, length = 1, needs = set(['固有名詞', '名詞']))
	print(key[0][0])
	# if command == 'learn':
	# 	print('学習しました。')
