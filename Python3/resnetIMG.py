...
def train(DIR = "", saveDIR = "/Users/xxxx/OneDrive/imgs/DRNmodel" ):
...
if __name__ == '__main__':
    ...
    from itertools import chain
    model = "/Users/xxxx/OneDrive/imgs/DNNmodel2" 
    filename = 'maki/sr-maki-cool-shoki-go.jpg'
    DIR = 'hanayo/'
    # preIMGprocess(DIR = "", workDIR ='_imgswork')

    train(DIR = "_test/", saveDIR = "/Users/xxxx/OneDrive/imgs/DRNmodel" )
