...
if __name__ == '__main__':
	...
	DIR = '/Users/xxxx'
# 
	train(DIR = "/Users/xxxx/OneDrive/imgs/learn/_work/", saveDIR = "/Users/xxxx/OneDrive/imgs/DNN_1-3-MV3")

	# adrs = [DIR+clsdir for clsdir in os.listdir(DIR) if not clsdir in {'.DS_Store', 'except'}]
	# print([predictAns(filename  =adr, isShow = 0, model = "/Users/xxxx/OneDrive/imgs/DNN_1-3-MV3")[0] for adr in adrs[:10]])
