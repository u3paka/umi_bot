...
if __name__ == '__main__':
  ...
  try:
    ...
    intext = '''ガバナンス'''
  # randnum = np.random.randint(10)
  ans = dialog(intext, isRandMetaS = 0, isPrint = True, isLearn = False, n =5, tryCnt = 10, needs = set(['名詞', '固有名詞', '形容詞']))
  print(ans)
  ...
  # teachers = [UserObject.screen_name for UserObject in twtr.list_members('_apkX', 'umi',  -1)]
  # print(teachers)
  # umi =  dealSQL.getTweetList(n = 100000, UserList = ['omorashi_umi', 'maid_umi_bot', 'lovely_umi', 'ultimate_umi', 'sousaku_umi', 'Jyuken_Umi', 'admiral_Sonoda', 'sonoda_smoke', 'sleep_umi', 'umi0315_pokemon', 'aisai_umi', 'quiet_umi_', 'harem_Umimi_bot'])
  # print(len(umi))
