...
def conv_model(X, y, keep_prob = 0.5):
	...
	# return skflow.ops.softmax_classifier(h_fc1, y, weights = weight_variable([1024, NUM_CLASSES]), biases = bias_variable([NUM_CLASSES]), class_weight=None, name=None)
def CNNmodel(X, y):
