...
if __name__ == '__main__':
	...
	train(DIR = "/Users/xxxx/OneDrive/imgs/learn/_work/", saveDIR = "/Users/xxxx/OneDrive/imgs/DNN_1-3-MV")

	adrs = [DIR+clsdir for clsdir in os.listdir(DIR) if not clsdir in set(['.DS_Store'])]
	print([predictAns(filename  =adr, isShow = 0, model = "/Users/xxxx/OneDrive/imgs/DNN_1-3_8")[0] for adr in adrs[:10]])
